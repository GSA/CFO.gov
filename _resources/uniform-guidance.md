...
In 2024, OMB released an updated version of the <a href="{{site.baseurl}}/assets/files/Final 2 CFR Guidance - 4.3.2024 - Pre-Publication Version.pdf">Uniform Guidance</a> and issued an accompanying <a href="https://www.whitehouse.gov/omb/information-for-agencies/memoranda/#memoranda-2024" target="_blank">implementation memorandum</a> as well as <a href="{{site.baseurl}}/assets/files/Uniform Guidance _Reference Guides FINAL 4-2024.pdf">reference guides</a>.
