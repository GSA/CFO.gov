...
<div class="card-content-column behavior">
  ...
  <dl><dt>Budget Execution ( Level 4 - Advanced)</dt><dd>Summarizes information related to audit findings to identify condition, criteria, cause and effect to communicate potential concerns</dd><dt>Budget Execution ( Level 5 - Expert)</dt><dd>Oversees and manages all aspects of the financial process on behalf of a Department to ensure financial accountability</dd></dl>
</div>
